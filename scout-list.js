...
async function loadScouts() {
    ...
    try {
        ...
        querySnapshot.forEach((docSnap) => {
            ...
            // স্কাউট লিস্টে শুধু সেসকল মেম্বার দেখাবে যারা পেন্ডিং নয় এবং ইনঅ্যাক্টিভ নয়
        ...
        console.error("স্কাউট লিস্ট লোড করতে সমস্যা:", err);
...
function renderScouts(scouts) {
    ...
    if (scouts.length === 0) {
        contentDiv.innerHTML = "<p style='color:#94a3b8; text-align:center; padding: 20px;'>কোনো সক্রিয় সদস্য নেই।</p>";
        return;
    }
            ...
            rightActionHTML = `
                <div class="action-area">
                    ...
                    <div class="toggle-container">
                        <span class="status-text" id="st-label-${scout.uid}">Active</span>
                        <label class="switch">
                            <input type="checkbox" onchange="toggleInactiveStatus('${scout.uid}', this)">
...
// স্কাউট লিস্টে ইনঅ্যাক্টিভ করলে ডাটাবেজে স্ট্যাটাস আপডেট হয়ে লিস্ট থেকে রিমুভ হয়ে যাবে
window.toggleInactiveStatus = async function(uid, checkboxElement) {
    if (!isAdultLeader) return;
    let newStatus = checkboxElement.checked ? "inactive" : "active";
    let confirmMsg = checkboxElement.checked ? "আপনি কি নিশ্চিতভাবে এই সদস্যকে ইনঅ্যাক্টিভ করতে চান? (তাহলে এটি ইনঅ্যাক্টিভ পেজে চলে যাবে)" : "আপনি কি এই সদস্যকে আবার অ্যাক্টিভ করতে চান?";
    ...
    if (confirm(confirmMsg)) {
        try {
            ...
            // তালিকা রিফ্রেশ করলে ইনঅ্যাক্টিভ হওয়া মেম্বার এই লিস্ট থেকে সরে যাবে
            loadScouts();
        } catch (err) {
